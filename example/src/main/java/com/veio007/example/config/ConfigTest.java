package com.veio007.example.config;
...
public class ConfigTest {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		// netflix config使用
		Properties prop = ConfigurationUtils.loadPropertiesFromInputStream(Files.newInputStreamSupplier(new File("config/rp.properties")).getInput());
