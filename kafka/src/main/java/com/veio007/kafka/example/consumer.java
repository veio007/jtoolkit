package com.veio007.kafka.example;

import com.alibaba.fastjson.JSONObject;
import com.veio007.kafka.core.IKConsumerAction;
import com.veio007.kafka.core.KConsumer;
...
public class consumer {
	public static void main(String[] args) throws InterruptedException {
		...
		// com.veio007.kafka topic(添加gt.前缀是和kafka已有配置区分，在传给KafkaConsumer类前会移除掉)
