...
public class KConsumer extends AbstractBase {
	...
	public KConsumer(String json, final IKConsumerAction action) {
		...
		props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, "org.apache.com.veio007.kafka.common.serialization.StringDeserializer");
		props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "org.apache.com.veio007.kafka.common.serialization.StringDeserializer");
